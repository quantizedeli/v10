...
class DatasetGenerationPipeline:
    """
    Ana Dataset Generation Pipeline
    ...
    def __init__(self, 
        ...
        """
        Args:
            source_data_path: Ham veri dosyası yolu
        ...
        # [SUCCESS] UPDATED: 75, 100, 150, 200, ALL (all available nuclei)
...
def main():
    ...
    NUCLEUS_COUNTS = [75, 100, 150, 200, 'ALL']  # [SUCCESS] UPDATED per requirements
