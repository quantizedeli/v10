"""
Nuclear Physics Constants and Configuration - UPDATED
Nükleer Fizik Sabitleri ve Konfigürasyon

Version: 1.1.0 - Timeout ve Overfitting Kontrolü Eklendi
"""
...
# ============================================================================
# WOODS-SAXON PARAMETRELERİ
# ============================================================================

WOODS_SAXON_PARAMS = {
    'V0': -51.0,  # MeV (depth)
    'r0': 1.27,   # fm
    'a': 0.67     # fm (surface diffuseness)
}

# ============================================================================
# SHELL MODEL PARAMETRELERİ
# ============================================================================
...
TIMEOUT_CHECK_FREQUENCY = 10  # Check timeout every N iterations
...
OVERFITTING_TRAIN_VAL_GAP = 0.15  # If train R² - val R² > 0.15, overfitting
...
CHANGELOG = """
v1.1.0 (2025-10-15):
  - FAZ 0: Timeout parametreleri eklendi (MAX_TRAINING_TIME, CHECKPOINT_INTERVAL)
  - FAZ 0: Overfitting detection parametreleri eklendi
  - FAZ 0: Early stopping parametreleri eklendi
...
if __name__ == "__main__":
    ...
    print(f"\nTimeout Settings:")
    print(f"  MAX_TRAINING_TIME: {MAX_TRAINING_TIME}s ({MAX_TRAINING_TIME/3600:.1f} hour)")
    print(f"  CHECKPOINT_INTERVAL: {CHECKPOINT_INTERVAL}s")
    print(f"  OVERFITTING_TRAIN_VAL_GAP: {OVERFITTING_TRAIN_VAL_GAP}")
